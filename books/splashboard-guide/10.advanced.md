...
:::message
📸 **TODO**: `gauge_line` で `habit · 6 / 10` のゲージが描画された screenshot
:::
...
:::message
📸 **TODO**: `grid_heatmap` で 1 ヶ月 × 7 曜日の読書ログ ( 曜日ラベル付き ) を描いた screenshot
:::
...
:::message
📸 **TODO**: `clock_countdown` × `text_ascii` で「あと N 日」を巨大表示した年末カウントダウン splash
:::
